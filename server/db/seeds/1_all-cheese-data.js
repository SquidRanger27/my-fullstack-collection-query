export async function seed(knex) {
  await knex('cheeses').insert([
    ...
    },
    {
      ...
      cheese_box: 53,
      name: 'CHILI CACIOTTA',
      maker: 'VIAVIO ITALIAN CHEESE',
      description: `Caciotta is a fresh, semi-soft cheese with a firm but very creamy texture. It’s mild and a little sweet, and this version has the added kick of some chili. Perfect for salads, and it melts perfectly like a raclette. Find a good dry Prosecco, a light IPA or a light soda and enjoy.`,
      region: 'Nelson',
      type_of_milk: 'Cow',
    },
    {
    ...
    },
    {
      id: 207,
      cheese_box: 53,
      name: 'MOUNT PEEL BLUE',
      maker: 'GERALDINE CHEESE',
      description: `Mt Peel Blue is a rich, buttery and smooth blue. It’s great crumbled over vegetables for a spring salad. Try it with a brown ale, a port, or a black tea.`,
      region: 'South Canterbury',
      type_of_milk: 'Cow',
    },
    {
    ...
    },
    {
      ...
      name: 'CHEVRE',
      maker: 'LITTLE FARM GOAT DAIRY',
      description: `This fabulous cheese is bright, a little tart, and simply delicious. Spread it on a piece of baguette you’ve ripped off and enjoy on a sunny day under a tree. Match it with Champagne, a bright Pilsner, or an artisan lemonade.`,
      region: 'Canterbury',
      type_of_milk: 'Goat',
    },
    {
      id: 210,
      cheese_box: 53,
      name: 'BLACK WAX CHEDDAR',
      maker: 'GERALDINE CHEESE',
      description: `This cheddar is made by one of New Zealand’s leading cheesemakers. It has a bit of bite to it like a good cheddar should. As the cheese dries the flavour becomes more concentrated. It’s spring so ideal timing to match it with a fresh Saison, a Chardonnay or berry mocktail. It goes well with tart cherries or a slice of pineapple too.`,
      region: 'Canterbury',
      type_of_milk: 'Cow',
    },
    {
      id: 211,
      cheese_box: 53,
      name: 'WALNUT AND FENUGREEK BEL PASO',
      maker: 'MERCER CHEESE',
      description: `This rare cheese is a creamy delight. It’s an Italian style manufactured using late season high fat milk with the addition of walnut pieces and fenugreek seeds by a highly-experienced Kiwi cheesemaker originally from the Netherlands. Try it with a light whisky, a sauvignon blanc, or be radical and a ginseng tea.`,
      region: 'Waikato',
      type_of_milk: 'Cow',
    },
    {
      ...
      name: 'TASMAN BLUE',
      maker: 'LITTLE RIVER ESTATE',
      description: `This is a gentle, very creamy and moist blue with some spice tones. It’s a Shropshire style with the orange coming from the addition of the juice of annatto berries from Brazil.  Match it with a big Cabernet Sauvignon, a traditional bitter beer, or a cup of black tea.`,
      region: 'Nelson',
      type_of_milk: 'Cow',
    },
  ])
